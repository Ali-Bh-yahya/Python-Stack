...
ali.make_deposit(4000)
ali.make_deposit(3000)
ali.make_withdrawal(2000)
...
yazan.make_deposit(4000)
yazan.make_withdrawal(2000)
yazan.make_withdrawal(1500)
yazan.display_user_balance()

#Have the Izz make 1 deposit and 1 withdrawal and then display their balance:
izz.make_deposit(1000)
izz.make_withdrawal(500)
izz.make_withdrawal(500)
izz.make_withdrawal(500)
izz.display_user_balance()